    ...
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        <div className="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a className="sidebar-brand brand-logo" href="index.html"><img src={require('../../assets/images/meulabs.svg')} alt="logo" /></a>
        ...
        <ul className="nav">
            ...
            <div className="profile-desc">
              <div className="profile-pic">
                ...
                <div className="profile-name">
                  <h5 className="mb-0 font-weight-normal"><Trans>Shayen Yatagama</Trans></h5>
          ...
          <li className={ this.isPathActive('/campaigns') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
            <Link className="nav-link" to="/campaigns">
              <span className="menu-icon"><i className="mdi mdi-bullhorn"></i></span>
              <span className="menu-title"><Trans>Campaigns</Trans></span>
            </Link>
          </li>
